<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="information.aspx.cs" Inherits="排课系统.student.info" %>
        ...
        <div class="sidebar-wrap">
            ...
            <div class="sidebar-content">
                <ul class="sidebar-list">
                    ...
                    <li>
                        <ul class="sub-menu">
                            <li><a href="courseplan.aspx"><i class="icon-font">&#xe052;</i>学生课表</a></li>
                ...
                <div class="result-wrap">
                    ...
                    <div class="result-content">
                        <ul class="sys-info-list">
                            <li>
                                <label class="res-lab">学号</label><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                            </li>
                             <li>
                                 <label class="res-lab">姓名</label><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
                             </li>
                            <li>
                                <label class="res-lab">专业</label><asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>
                            </li>
                            <li>
                                <label class="res-lab">年级</label><asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
                            </li>
                        </ul>
                    </div>
                    </div>
