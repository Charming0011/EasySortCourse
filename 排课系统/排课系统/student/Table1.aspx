<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Table1.aspx.cs" Inherits="排课系统.student.Table1" %>
    ...
    <div class="topbar-wrap white">
        <div class="topbar-inner clearfix">
            <div class="topbar-logo-wrap clearfix">
                <h1 class="topbar-logo none"><a href="index.aspx" class="navbar-brand">学生管理</a></h1>
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="iconfont">&#xe602;&nbsp;</i><a href="index.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">课表管理</span></div>
        </div>
