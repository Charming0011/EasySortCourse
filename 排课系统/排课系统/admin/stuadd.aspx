<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuadd.aspx.cs" Inherits="排课系统.admin.stuadd" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="iconfont"&#xe602;&nbsp;></i><a href="index.aspx">首页</a><span class="crumb-step">&gt;</span><a href="teacherman.aspx">学生管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增教师</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">学生学号</label><asp:TextBox ID="TextBox1" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">学生姓名</label><asp:TextBox ID="TextBox2" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">学生专业</label><asp:TextBox ID="TextBox3" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">学生年级</label><asp:TextBox ID="TextBox4" runat="server" class="common-text"
