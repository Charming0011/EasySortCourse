<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacherman.aspx.cs" Inherits="排课系统.admin.teacherman" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="iconfont">&#xe602;&nbsp;</i><a href="index.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">教师管理</span></div>
        </div>
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            <asp:BoundField DataField="teachid" HeaderText="教师工号" ReadOnly="True" />
                            <asp:BoundField DataField="name" HeaderText="教师姓名" />
                            <asp:BoundField DataField="zhicheng" HeaderText="教师职称" />
                            <asp:BoundField DataField="xueli" HeaderText="教师学历" />
