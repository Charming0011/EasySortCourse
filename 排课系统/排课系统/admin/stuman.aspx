<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuman.aspx.cs" Inherits="排课系统.admin.stuman" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="iconfont">&#xe602;&nbsp;</i><a href="index.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">学生管理</span></div>
        </div>
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            <asp:BoundField DataField="stuid" HeaderText="学生学号" ReadOnly="True" />
