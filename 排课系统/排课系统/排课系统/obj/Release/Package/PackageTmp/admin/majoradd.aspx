<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="majoradd.aspx.cs" Inherits="排课系统.admin.majoradd" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增专业</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">专业名称</label><asp:TextBox ID="TextBox1" runat="server" 
                            Width="590px"></asp:TextBox>
                    </li>
                     <li>
                    <label class="res-lab">专业人数</label><asp:TextBox ID="TextBox3" runat="server" 
                            Width="590px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">专业说明</label><asp:TextBox ID="TextBox2" runat="server" 
                            TextMode="MultiLine" Height="86px" Width="586px"></asp:TextBox>
                    </li>
                    <li>
